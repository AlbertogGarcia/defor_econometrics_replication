...
proptreat_landscape <- function(nobs, cellsize_list, ppoints, cpoints){
  ...
  #determine treated vs. untreated properties
  ...
  outputs = list('pixloc_df' = pixloc_df, "p_bounds" = v_property, "c_bounds" = v_county)
  return(outputs)
